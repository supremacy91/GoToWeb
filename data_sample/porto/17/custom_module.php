...
$output["custom_module_module"] = array (
    ...
    array (
      $language_id => '                            <div class="widget widget-block2" style="margin-top: 10px">
                                ...
                                <div class="owl-carousel widget-banner-slider">
                                    <div>
                                        <a href="#">
                                            <img src="image/catalog/porto/index17/ad1.jpg" alt="banner">
                                        </a>
                                    </div>
                                    <div>
                                        <a href="#">
                                            <img src="image/catalog/porto/index17/ad2.jpg" alt="banner">
                                        </a>
                                    </div>
  ...
  array (
    ...
    'html' => 
    array (
      $language_id => '<div style="background: #2c3232">
<div class="container">
<div class="row clean-row info-boxes-container">
                            ...
                            <div class="col-md-3 info-box-container">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        <h3 class="info-box-title">LIVE CHAT</h3>
                                        <div class="info-box-desc">Lorem ipsum dolor sit amet.</div>
                                    </div>
                                </div>
                            </div>
