...
$output["custom_module_module"] = array (
    ...
    array (
      $language_id => '                            <div class="widget widget-block2" style="margin-top: 10px">
                                ...
                                <div class="owl-carousel widget-banner-slider">
                                    <div>
                                        <a href="#">
                                            <img src="image/catalog/porto/index9/ad1.jpg" alt="banner">
                                        </a>
                                    </div>
                                    <div>
                                        <a href="#">
                                            <img src="image/catalog/porto/index9/ad2.jpg" alt="banner">
                                        </a>
                                    </div>
  ...
  array (
    ...
    'html' => 
    array (
      $language_id => '<div class="content-info-box-wrapper white">
      ...
      1 => '<div class="content-info-box-wrapper white">
                        <div class="row clean-row info-boxes-container">
                            <div class="col-md-4 info-box-container">
                                <div class="info-box">
                                    <div class="info-box-icon">
  ...
  array (
    ...
    'html' => 
    array (
      $language_id => '<div class="banner" style="margin-top: 15px">
	<a href="#">
	<img src="image/catalog/porto/index9/banner5.jpg" alt="Banner">
	</a>
</div>',
      1 => '<div class="banner" style="margin-top: 15px">
	<a href="#">
	<img src="image/catalog/porto/index9/banner5.jpg" alt="Banner">
	</a>
</div>',
  ...
  array (
    ...
    'html' => 
    array (
      $language_id => '<div class="row" style="margin-top: 15px">
    <div class="col-sm-3 col-xs-6 col-xss-12">
        <div class="banner">
            <a href="#"><img src="image/catalog/porto/index9/banner1.png" alt="banner"></a>
        </div><!-- End .banner -->
    </div><!-- End .col-sm-3 -->
    <div class="col-sm-3 col-xs-6 col-xss-12">
        <div class="banner">
            <a href="#"><img src="image/catalog/porto/index9/banner2.jpg" alt="banner"></a>
        </div><!-- End .banner -->
    </div><!-- End .col-sm-3 -->
    <div class="col-sm-3 col-xs-6 col-xss-12">
        <div class="banner">
            <a href="#"><img src="image/catalog/porto/index9/banner3.png" alt="banner"></a>
        </div><!-- End .banner -->
    </div><!-- End .col-sm-3 -->
    <div class="col-sm-3 col-xs-6 col-xss-12">
        <div class="banner">
            <a href="#"><img src="image/catalog/porto/index9/banner4.png" alt="banner"></a>
        </div><!-- End .banner -->
    </div><!-- End .col-sm-3 -->
</div><!-- end .row -->',
      1 => '<div class="row" style="margin-top: 15px">
    <div class="col-sm-3 col-xs-6 col-xss-12">
        <div class="banner">
            <a href="#"><img src="image/catalog/porto/index9/banner1.png" alt="banner"></a>
        </div><!-- End .banner -->
