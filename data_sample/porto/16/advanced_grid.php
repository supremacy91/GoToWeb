...
$output["advanced_grid_module"] = array (
  ...
  array (
    ...
    'background_image' => 'catalog/porto/index16/bg-parallax.png',
      ...
      array (
        ...
        array (
          ...
          array (
            ...
            'html' => 
            array (
              $language_id => '<div class="parallax-info parallax-info2" style="background: none">  
                  <div class="lg-margin2x"></div><!-- space -->
                    <div class="">
                        <div class="owl-carousel info-carousel">
                            <div class="info-carousel-block">
                                <h2>Special <strong>Promo</strong></h2>
                                <h4>Up to <strong>70% OFF</strong> in the new collection.</h4>
              ...
              1 => '<div class="parallax-info parallax-info2" style="background: none">  
                  <div class="lg-margin2x"></div><!-- space -->
                    <div class="">
                        <div class="owl-carousel info-carousel">
                            <div class="info-carousel-block">
