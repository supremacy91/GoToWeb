...
$output["custom_module_module"] = array (
  ...
  array (
    ...
    <div class="col-sm-3 col-xs-6 col-xss-12">
        <div class="banner">
            <a href="#"><img src="image/catalog/porto/index4/banner1.png" alt="banner"></a>
        </div><!-- End .banner -->
    </div><!-- End .col-sm-3 -->
    <div class="col-sm-3 col-xs-6 col-xss-12">
        <div class="banner">
            <a href="#"><img src="image/catalog/porto/index4/banner2.png" alt="banner"></a>
        </div><!-- End .banner -->
    </div><!-- End .col-sm-3 -->
    <div class="col-sm-3 col-xs-6 col-xss-12">
        <div class="banner">
            <a href="#"><img src="image/catalog/porto/index4/banner3.png" alt="banner"></a>
        </div><!-- End .banner -->
    </div><!-- End .col-sm-3 -->
    <div class="col-sm-3 col-xs-6 col-xss-12">
        <div class="banner">
            <a href="#"><img src="image/catalog/porto/index4/banner4.png" alt="banner"></a>
        </div><!-- End .banner -->
    </div><!-- End .col-sm-3 -->
</div><!-- end .row -->

<div class="md-margin half"></div><!-- space -->',
      1 => '<div class="row">
    <div class="col-sm-3 col-xs-6 col-xss-12">
        <div class="banner">
            <a href="#"><img src="image/catalog/porto/index4/banner1.png" alt="banner"></a>
...
<div class="lg-margin"></div><!--space -->',
  ...
  array (
    ...
    'html' => 
    array (
      $language_id => '<div class="md-margin2x half"></div><!--space -->
...
<div class="brands-carousel-container">
    <div class="owl-carousel brands-carousel">
        <div class="brand">
            <a href="#"><img src="image/catalog/porto/index4/brand1.png" alt="Brand name"></a>
        </div><!-- End .brand -->
        <div class="brand">
            <a href="#"><img src="image/catalog/porto/index4/brand2.png" alt="Brand name"></a>
        </div><!-- End .brand -->
        <div class="brand">
            <a href="#"><img src="image/catalog/porto/index4/brand3.png" alt="Brand name"></a>
        </div><!-- End .brand -->
        <div class="brand">
            <a href="#"><img src="image/catalog/porto/index4/brand4.png" alt="Brand name"></a>
        </div><!-- End .brand -->
        <div class="brand">
            <a href="#"><img src="image/catalog/porto/index4/brand5.png" alt="Brand name"></a>
        </div><!-- End .brand -->
        <div class="brand">
            <a href="#"><img src="image/catalog/porto/index4/brand2.png" alt="Brand name"></a>
        </div><!-- End .brand -->
...
<div class="sm-margin half"></div><!-- space -->',
      1 => '<div class="md-margin2x half"></div><!--space -->
